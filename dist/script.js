...
window.addEventListener("DOMContentLoaded", function () {
  ...
  Object(_modules_tabs_js__WEBPACK_IMPORTED_MODULE_2__["default"])(".decoration_slider", ".no-click", ".decoration_content", "after-click");
});
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      item.addEventListener("click", function (e) {
        ...
        e.preventDefault();
        modal.style.display = "block"; // для того что бы сайт не листался когда модальное окно открыто
